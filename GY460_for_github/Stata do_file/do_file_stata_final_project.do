...
* We reproduce the same thing but for thev 2017-2019 period with the retail (dif_eff47 & rdif_eff47) and catering (dif_eff56 & dif_eff56) secor
...
* For the second part of the study, we will only be interested by the CUD. Each observation is a sqaure of 200m by 200m with at least 11 people (minimal statistical information available). We will study the population change between squares within a 500m radius from the bus stop (treated group) and squares that are not within this 500m radius, in the rest of the CUD. 
